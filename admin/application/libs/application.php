...
class Application
{
     ...
     * Analyze the ADMIN_URL elements and calls the according controller/method or the fallback
     */
    public function __construct()
    {
        // create array with ADMIN_URL parts in $url
        $this->splitUrl();
        ...
        if (file_exists('./application/controller/' . $this->url_controller . '.php')) {
            ...
            // invalid ADMIN_URL, so simply show dashboard/index
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            // Put ADMIN_URL parts into according properties
            ...
            // for debugging. uncomment this if you have problems with the ADMIN_URL
