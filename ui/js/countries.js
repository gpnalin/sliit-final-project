...
// // 	var option_str = document.getElementsByName(country_id);
// // 	option_str.length=0;
// // 	option_str.options[0] = new Option('Select Country','default');
// // 	option_str.selectedIndex = 0;
// // 	for (var i=0; i<country_arr.length; i++) {
// // 		option_str.options[option_str.length] = new Option(country_arr[i],country_arr[i]);
// // 	}
...
// 		//var option_str = document.getElementsByName(state_id);
